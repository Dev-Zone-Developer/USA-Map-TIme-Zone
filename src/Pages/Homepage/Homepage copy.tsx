...
const zoneStyles: Record<TimeZoneKey, ZoneStyles> = {
    ...
    eastern: { headerBg: 'bg-[#35BAAE]', headerText: 'text-white', borderColor: '#bfdbfe', bgColor: '#F5F6FA' },
    central: { headerBg: 'bg-[#EDC563]', headerText: 'text-white', borderColor: '#bbf7d0', bgColor: '#F5F6FA' },
    mountain: { headerBg: 'bg-[#FD887C]', headerText: 'text-white', borderColor: '#fde68a', bgColor: '#F5F6FA' },
    pacific: { headerBg: 'bg-[#38384F]', headerText: 'text-white', borderColor: '#e9d5ff', bgColor: '#F5F6FA' },
};
        ...
        <>
            ...
            <main className={`p-4 mt-2 md:p-8 min-h-screen ${user.mode == "light" ? "bg-[#F5F6FA]" : "bg-[#1B1B1F]"}`}>
                ...
                <div className="w-4/5 bg-white p-5 py-2 my-8 mx-auto rounded-2xl flex flex-wrap justify-between items-center gap-3 shadow-md">
                    ...
                    <img className="w-7 cursor-pointer" src="/printer.png" alt="printer" draggable={false} />
                    <Togglemode />
                </div>
